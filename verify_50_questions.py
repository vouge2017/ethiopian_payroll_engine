...
from payroll_engine.models import Company, Employee, OvertimeEntry, PayrollRun, Payslip, TenantQuery, User, db
...
if cash_flags:
    ok(16, "Cash compliance FLAG for ETB 52,000 net without bank")
else:
...
with app.app_context():
    ...
    if has_portal:
        ...
        fail(24, "Employee portal routes missing")
...
with app.app_context():
    ...
    if transport.calculated_exempt_amount == Decimal('600') and hardship.calculated_exempt_amount == Decimal('1500'):
        ok(26, "Transport: 600 exempt of 2000 (cap), Hardship: 1500 fully exempt")
    else:
...
if os.path.exists(pdf_path) and os.path.getsize(pdf_path) > 1000:
    ...
    fail(31, "PDF not generated or too small")
